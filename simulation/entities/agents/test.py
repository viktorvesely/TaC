...
class TestAgent(Agent):
    ...
    def __init__(self, position: np.ndarray) -> None:
        ...
        self.moving = False # Flag to identify if agent is currently moving
    ...
    def tick(self):
        ...
        if not self.moving:
            # Create new animation that moves agent to random position over 0.8 seconds
            ...
            self.moving = True # Set moving flag to true
